    ...
    <div class="container">
        <main>
            <div class="py-5 text-center">
                ...
                <p class="lead">Silakan ubah atribut buku yang diinginkan</p>
            </div>
            <div class="row g-5">
                    ...
                    <form action="editBook.php" class="needs-validation" novalidate method="post">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="author" id="author" placeholder="Penulis" value="<?php echo $author ?>" required class="form-control">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="date" name="published_date" id="published_date" value="<?php echo $published_date ?>" required class="form-control">
                                <div class="invalid-feedback">
                        ...
                        <button class="w-100 btn btn-primary btn-lg" type="submit">Sunting buku</button>
